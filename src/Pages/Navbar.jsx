        ...
        <NavLink
          ...
          style={({ isActive, isPending }) => {
            return {
              ...
              backgroundColor: isPending ? "transparent" : "white",
            };
          }}
        >
          Home
        ...
        <NavLink
          ...
          style={({ isActive, isPending }) => {
            return {
              fontWeight: isActive ? "bold" : "",
              color: isPending ? "red" : "green",
              backgroundColor: isPending ? "blue" : "white",
            };
          }}
        >
          About
  ...
  return (
    <div className="navbar bg-base-100">
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 flex items-center gap-2">{navItem}</ul>
      </div>
